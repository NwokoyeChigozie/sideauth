...
func TestGetBusinessProfile(t *testing.T) {
	...
	businessProfile := models.BusinessProfile{AccountID: accountID}
	...
	tests := []struct {
		Name         string
		RequestBody  models.GetBusinessProfileModel
		ExpectedCode int
	...
	{
		authTypeUrl.POST("/get_business_profile", auth_model.GetBusinessProfile)
	...
	for _, test := range tests {
		t.Run(test.Name, func(t *testing.T) {
			...
			URI := url.URL{Path: "/v2/auth/get_business_profile"}
