...
type BusinessProfile struct {
	...
	DisbursementSettings              string  `gorm:"column:disbursement_settings; type:varchar(255); not null; default:'instant';comment:'instant|accumulate'" json:"disbursement_settings"`
	...
	EscrowCharge                  jsonmap   `gorm:"column:escrow_charge; -:migration" json:"escrow_charge"`
